...
export const TYPE_PAIRINGS = [
  ...
  },
  {
    id: 'geist',
    name: 'Geist',
    note: 'Sans de producto, neutra y muy actual. Tono software',
    values: {
      headingFamily: '"Geist", system-ui, sans-serif',
      bodyFamily: '"Geist", system-ui, sans-serif',
      monoFamily: '"IBM Plex Mono", ui-monospace, monospace',
      headingWeight: 600,
      headingCase: 'none',
      headingTracking: '-0.03em',
  ...
  },
  {
    ...
    note: 'Serif de texto para lectura larga. Editorial y despacho',
    values: {
